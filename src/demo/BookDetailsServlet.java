...
/**
 * Created by 143292l on 10/29/15.
 */
...
public class BookDetailsServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        out.println("<html><head><title>Duke's Bookstore</title></head><body bgcolor=\"#ffffff\"><center><hr> <br> &nbsp;<h1><font size=\"+3\" color=\"#CC0066\">Duke's </font>" +
                " <img src=\"./duke.books.gif\" alt=\"Duke holding books\"\"><font size=\"+3\"color=\"black\">Bookstore</font></h1></center><br><hr> <br>");
